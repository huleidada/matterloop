...
`v0.1.1` 的 12 个发行包均提供 wheel、sdist 和 Trusted Publishing 发布证明；对应的发布记录见
[GitHub Release](https://github.com/huleidada/matterloop/releases/tag/v0.1.1)。建议在虚拟环境中安装，
...
预期输出版本 `0.1.1`，且 `pip check` 报告 `No broken requirements found`。
