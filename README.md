...
| 4 | `matterloop-tools` | `matterloop_tools` | 工具协议、注册表、受限文件、Shell 和 HTTP 工具 |
...
各包的构造参数、公共字段、安全限制和最小示例位于对应发行包的 README。仓库还提供三个
[可运行企业离线示例](examples/enterprise/)，覆盖单 Agent、TeamLoop 和队列服务组合。
